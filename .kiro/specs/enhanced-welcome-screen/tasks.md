...
- [x] 1. Crear el módulo de lógica pura y persistencia del nombre (`src/data/playerName.js`)
  - [x] 1.1 Implementar sanitización, validación y constantes del nombre
  ...
  - [x]* 1.2 Escribir property test para `sanitizeName`
  ...
  - [x]* 1.3 Escribir property test para `isValidName`
  ...
  - [x] 1.4 Implementar el nombre activo de partida (`commitName`)
  ...
  - [x]* 1.5 Escribir property test para `commitName`
  ...
  - [x] 1.6 Implementar persistencia en localStorage (`persistIfValid`, `loadStoredName`)
  ...
  - [x]* 1.7 Escribir property test de round-trip de persistencia
  ...
  - [x]* 1.8 Escribir property test de no-modificación para entradas inválidas
  ...
  - [x] 1.9 Implementar el formateo del detalle de Game Over (`formatGameOverDetail`)
  ...
  - [x]* 1.10 Escribir property test para `formatGameOverDetail`
...
- [x] 2. Checkpoint - Validar la lógica pura
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Añadir DOM y CSS aditivos en la versión modularizada (`index.html`)
  - [x] 3.1 Insertar los nuevos elementos del `#startScreen` en `index.html`
  ...
  - [x] 3.2 Añadir las reglas CSS aditivas reutilizando variables existentes
  ...
  - [x]* 3.3 Escribir unit tests de estructura del DOM de bienvenida (jsdom)
...
- [x] 4. Extender la capa de UI (`src/ui/screens.js`)
  - [x] 4.1 Implementar `bindPlayerNameInput` y `getPlayerNameInputValue`
  ...
  - [x] 4.2 Modificar `showGameOverScreen` para mostrar el nombre opcional
  ...
  - [x]* 4.3 Escribir unit tests de UI (jsdom)
...
- [x] 5. Conectar todo en `src/main.js`
  - [x] 5.1 Cablear la gestión de nombre en la inicialización y el flujo de partida
  ...
  - [x]* 5.2 Escribir test de integración del flujo (jsdom)
...
- [x] 6. Reflejar el cambio en el monolito para paridad (`torre-de-las-nubes.html`)
  - [x] 6.1 Replicar DOM, CSS y lógica de nombre inline en el monolito
...
- [x] 7. Checkpoint final - Asegurar que toda la suite pasa
  - Ensure all tests pass, ask the user if questions arise.
